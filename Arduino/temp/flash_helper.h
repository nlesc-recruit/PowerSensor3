...
typedef struct flash_reg_map {
    ...
    /*The above is all according to the datasheets?????*/
...
#define FLASH_OPTCR_STRT_BIT            1
#define FLASH_OPTCR_OPTLOCK_BIT         0

#define FLASH_OPTCR_BOR_LEV             BIT(FLASH_OPTCR_BOR_LEV_BIT)
#define FLASH_OPTCR_STRT                BIT(FLASH_OPTCR_STRT_BIT)
